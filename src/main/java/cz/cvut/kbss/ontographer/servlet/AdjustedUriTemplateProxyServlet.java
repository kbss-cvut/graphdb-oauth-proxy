 ...
 */
package cz.cvut.kbss.ontographer.servlet;
...
public class AdjustedUriTemplateProxyServlet extends URITemplateProxyServlet {
    ...
    protected void service(HttpServletRequest servletRequest,
        ...
        final String username = getConfigParam(Constants.USERNAME_PARAM);
        final String password = getConfigParam(Constants.PASSWORD_PARAM);
